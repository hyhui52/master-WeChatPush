...
public class CaiHongPiUtils {
    ...
    public static String getCaiHongPi() {
        //彩虹屁接口
        String httpUrl = "http://api.tianapi.com/caihongpi/index?key=aeeaac45dd96931256539e9474cacc8e";
    ...
    public static Map<String,String> getEnsentence() {
        //对接英语一句话接口
        String httpUrl = "http://api.tianapi.com/ensentence/index?key=aeeaac45dd96931256539e9474cacc8e";
        BufferedReader reader = null;
        String result = null;
        StringBuffer sbf = new StringBuffer();
        try {
