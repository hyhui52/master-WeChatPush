...
public class Pusher {
    ...
    private static String appId = "wxf93a59c3b7b5d395";
    private static String secret = "49ff12d7769f4812119b5820cce64526";
    ...
    public static void push(){
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser("oqMBk6v8Pq4tdwyVbzCPCqsftR-4")
                .templateId("7aGiEogfFx8npRlGrruRBXKHlSNDSIBiyPoiVuUuzxs")
                .build();
